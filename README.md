...
(`WindowCadesPluginAdapter`) are both implemented and tested against a mocked plugin — assembled
from CryptoPro's own documentation/demo code, but **not run yet against a real plugin/token/
`EncryptedKey` from Kontur.OFD**, see `docs/roadmap.md`, open question 1.
